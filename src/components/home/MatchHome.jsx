...
// <h1 className="text-2xl font-semibold mb-4">Match Almanet (Demo)</h1>
// {user ? (
// <>
// <div className="mb-4">Signed in: <strong>{user.email}</strong></div>
// <div className="flex gap-2">
// <Link to="/profile" className="px-4 py-2 bg-blue-600 text-white rounded">Profile</Link>
